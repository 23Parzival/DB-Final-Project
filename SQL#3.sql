...
Alter table Patient
add constraint Patient_insurance_id_fk foreign key (insurance_id) references InsuranceCompany (insurance_id)

Alter table Patient
alter column postal_code varchar(8) not null
...
constraint Visit_appointment_id_fk foreign key (appointment_id) references Appointment (appointment_id))
...
record_date date,
patient_id char(5),
constraint MedicalHistory_patient_id_fk foreign key (patient_id) references Patient (patient_id),
visit_id char(2),
...
visit_id char(2),
constraint Bill_visit_id_fk foreign key (visit_id) references Visit (visit_id))
...
bill_id char(6),
constraint InsuranceClaim_bill_id_fk foreign key (bill_id) references Bill (bill_id),
insurance_id char(4),
constraint InsuranceClaim_insurance_id_fk foreign key (insurance_id) references InsuranceCompany (insurance_id))
...
patient_id char(5),
constraint Payment_patient_id_fk foreign key (patient_id) references Patient (patient_id));
...
constraint BillPayment_payment_id_fk foreign key (payment_id) references Payment (payment_id))
...
Insert into Patient values('00001','Sony', 'Jr', '1998-03-23','514-324-7643', 'Montreal', 'Queen Mary', 'Quebec', 'HW1Y89', '1100')
Insert into Patient values('00002','Jones', 'DaSec', '1997-04-16','514-574-7868','Montreal','Saint-Luc', 'Quebec', 'FW5K90','2200')

Insert into Appointment values('01', '2026-05-20', '14:30:00', 'Scheduled', '0033', '00002')
Insert into Appointment values('02', '2026-07-14', '13:00:00', 'Scheduled', '0011', '00001')

Insert into Visit values('10', '2026-03-23', '12:40:00', '01')
Insert into Visit values('20', '2026-02-14', '16:05:00', '02')

Insert into Bill values('000111', '2026-4-23', 200.00, 200.00, '10')
Insert into Bill values('000222', '2026-3-14', 300.00, 250.00, '20')

Insert into InsuranceClaim values('10001', '2026-3-10', 'Claimed', '000111', '1100')
Insert into InsuranceClaim values('20002', '2026-4-23', 'Claimed', '000222', '2200')

Insert into Payment values('1010', '2026-04-20', 200.00, 'Patient', '00001'),
						  ('2020', '2026-03-10', 300.00, 'Insurance Company', '00002')

Insert into BillPayment 
values('000111', '1010', 200.00),
	  ('000222', '2020', 300.00)

Insert into MedicalHistory values('1234', 'Has cavity', ' Cavity needs to be remove', 50.00, '2025-09-23', '00001', '10'),
								 ('2345', 'Infection', 'Must be cured by oral anti-boitics', 300.00, '2024-05-07', '00002', '20')
